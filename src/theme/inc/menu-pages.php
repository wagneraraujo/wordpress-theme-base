  ...
  <div class="row line_menu">
    <div class="menuhamburger">
      <a href="#menumobile" class="toggle-menu" aria-role="button" >
        <svg width="30px" height="30px" viewBox="0 0 16 16" class="bi bi-text-left" fill="#808080" xmlns="http://www.w3.org/2000/svg">
...
?>
    ...
    <svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-cart3" fill="#808080" xmlns="http://www.w3.org/2000/svg">
